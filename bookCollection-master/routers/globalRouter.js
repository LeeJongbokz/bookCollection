...
import {home, getJoin, postJoin, getLogin, postLogin, logout, getIntro, myLibrary, myPage, getBookPage, page1, facebookLogin, postFacebookLogin, postIntro, postBookPage } from '../controllers/userControllers.js';
...
globalRouter.post(routes.login, passport.authenticate('local', {failureRedirect: routes.login}),
        function(req, res){
